...
let background = UIView(frame: CGRect(x: 0, y: 0, width: 120, height: 200))
background.backgroundColor = UIColor(red: 55.0/255.0, green: 57.0/255.0, blue: 70.0/255.0, alpha: 1.0)
let view = SliderView(frame: CGRect(x: 36, y:60, width: 45, height: 90))
